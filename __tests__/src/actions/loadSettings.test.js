...
import { loadSettings, LOAD_SETTINGS_REQUEST, LOAD_SETTINGS_SUCCESS, LOAD_SETTINGS_FAILURE } from '../../../src/actions/loadSettings';
  ...
  describe('the returned function', () => {
    ...
    describe('when settings has been set', () => {
      ...
      it('overrides the settings specified in config.js', () => {
        ...
        expect(settings.api.baseUrl).toBe(config.api.baseUrl);
      });
    });
