import postTransaction from '../../../src/api/postTransaction';
...
describe('postTransaction(transaction, options)', () => {
  let fakeTransaction;
  let fakeOptions;
  let returnValue;
  ...
  beforeEach(() => {
    ...
    fakeTransaction = {
      toString: () => '4a6c4ae1-d315-426d-8b56-0ea146d45d12'
    };
  ...
  describe('the HTTP request', () => {
    it('is made to the url ${options.baseUrl}/transaction', () => {
      const expectedUrl = '6a5d1a54-a707-449d-b866-1c29c9a21dc8/transaction';
